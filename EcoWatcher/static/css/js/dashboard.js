document.addEventListener('DOMContentLoaded', () => {
    ...
    btnAbrirTabla.addEventListener("click", () => modalTabla.showModal());
    ...
    tabs.forEach(btn => {
        btn.addEventListener("click", () => {
            ...
            if(current.id === target) return; // misma sección, no hacer nada

            loader.classList.add("show");       // mostrar loader
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    loader.classList.remove("show"); // ocultar loader
                }, 50);
            }, 1000); // duración de animación
        });
    });
